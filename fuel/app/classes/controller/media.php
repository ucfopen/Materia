...
class Controller_Media extends Controller
{
	...
	public function get_import()
	{
		...
		$s3_upload_url = $protocol.Config::get('materia.s3_config.uploads_bucket').".".Config::get('materia.s3_config.upload_url');
		$s3_thumbnail_url = (Config::get('materia.s3_config.verified_bucket'))
			? $protocol.Config::get('materia.s3_config.verified_bucket').".".Config::get('materia.s3_config.upload_url')
			: $s3_upload_url ;
