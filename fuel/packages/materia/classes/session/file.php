<?php
/**
 * Minor rewrite of Session_File to change how it reads from the disk
 * We we're seeing tons of problems where sessions were reading incomplete serialized strings
