...
7. With a superuser account, visit the Materia django admin page. Create a new LTI registration with the following values:
    ...
    - Auth URL: This is the URL for the authentication endpoint. For Canvas, this is https://devhub.cdl.ucf.edu/api/lti/authorize_redirect.
    - Access Token URL: This is the URL for the access token endpoint. For Canvas, this is https://devhub.cdl.ucf.edu/login/oauth2/token.
    - Keyset URL: This is the URL for the keyset endpoint. For Canvas, this is https://devhub.cdl.ucf.edu/api/lti/security/jwks.
