	...
	<section class="page no_flash">
		...
		<div class="get_flash" id="get_flash">
			<a href="http://www.adobe.com/go/getflashplayer">
				<img src="/assets/img/get_flashplayer.gif" alt="Download Flash Player" />
		...
		<p>Should this not fix your problems, please visit the <a href="<?= Uri::base() ?>help/">Help</a> pages for more information.</p>
	</section>
</div>