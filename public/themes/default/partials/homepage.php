...
<section class="get_started">
	...
	<p class="button_wrap"><a class="action_button" href="widgets">Get Started</a></p>
</section>
...
<section class="front_bottom">
	...
	<section class="p_s">
		<h2>Built at The University of Central Florida</h2>
		<p>
			Materia is designed, built, and supported by UCF, one of the largest state universies in the US. Our team melds interface usability, graphic design, instructional pedagogy, expert developers, and award winning distance learning expertise to deliver an innovative and usable platform for interactive learning content. Because of this, we can integrate very tightly with our university systems , such as exporting scores into your online course and user accounts that tie directly to your official credentials. We're committed to building a better tomorrow through better learning. As a result of this commitment, our team is constantly improving, tweaking, polishing, and re-inventing Materia. In fact, if you have an idea for a new widget or simply would like to give us feedback, we'd love to hear from you.
		</p>
		<p class="copyright">
