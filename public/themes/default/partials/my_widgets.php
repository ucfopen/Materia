	...
	<div ng-controller="SelectedWidgetController">
		...
		<section class="page"  ng-hide="noWidgetState == true || !selectedWidget && !error">
			<div class="header">
				...
				<span class="widgetname">{{selectedWidget.widget.name}}</span>
			</div>
			<div class="overview">
			...
			<div class="scores" ng-show="shareable && selectedWidget.widget.is_scorable">
				...
				<div class="scoreWrapper" ng-repeat="semester in scores.list" ng-if="show.olderScores == true || $index == 0">
					...
					<a role="button" class="show-older-scores-button" href="javascript:;" ng-show="scores.list.length > 1 && show.olderScores == false && $index == 0" ng-click="enableOlderScores()">Show older scores...</a>
				</div>
