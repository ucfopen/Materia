		...
		<div ng-controller="SelectedWidgetController">
					...
					<div class="download_wrapper">
						...
						<div class="score_table">
							...
							<div class="download-controls">
								...
								<p class="download"><a href ng-href="{{getDownloadLink()}}" class="action-button arrow_down_button orange" ng-class="{disabled: !header}"><span class="arrow_down"></span>Download File</a></p>
							</div>
						</div>
			...
			<section class="content" ng-hide="widgets.widgetList.length == 0 || !selected.widget || perms.error">
				...
				<div class="scores hidden-xs" ng-show="selected.widget.widget.is_scorable">
					...
					<span id="export_scores_button" class="action-button orange" ng-disabled="selected.scores.list.length == 0 || !selected.hasScores" ng-class="{'disabled': selected.scores.list.length == 0}" ng-click="exportPopup()">
