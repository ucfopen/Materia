			...
			<section class="page"  ng-hide="widgets.widgetList.length == 0 || !selected.widget && !error">
				...
				<div class="overview">
					...
					<div class="controls">
						...
						<div class="additional_options" ng-class="{'disabled': !selected.editable || !selected.shareable}" ng-show="!showDeleteDialog">
							<h3>Settings:</h3>
				...
				<div class="scores" ng-show="selected.shareable && selected.widget.widget.is_scorable">
					...
					<div class="scoreWrapper" ng-repeat="semester in selected.scores.list" ng-if="selected.showOlderScores == true || $index == 0">
						...
						<a role="button" class="show-older-scores-button" href="#" ng-show="selected.scores.list.length > 1 && selected.showOlderScores == false && $index == 0" ng-click="enableOlderScores()">Show older scores...</a>
					</div>
		...
		<aside ng-controller="SidebarController">
			...
			<div class="courses">
				<div class="widget_list" data-container="widget-list">
					<div ng-repeat="widget in widgets.widgetList | filter:query" id="widget_{{widget.id}}" class="widget" ng-class-odd="'odd'" ng-class-even="'even'" ng-class="{is_draft: widget.is_draft, gameSelected: widget.id == selected.widget.id}" ng-click="setSelected(widget.id)">
