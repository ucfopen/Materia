		...
		<>
			...
			<section className='full-width'>
				...
				<dl>
					...
					<dd>That depends on how your institution has configured Materia. If you visit Materia through your LMS, authentication is handled for you. If you login directly to Materia,
						you may need credentials specifically set up for Materia. If logging in transitions you to a an external login, use the credentials associated with that external login instead.
					</dd>
					...
					<dd>
						...
						Materia content embedded in Course B. Visiting Materia content in Course A will once again grant you the author role.
					</dd>
					...
					<dd>
						...
						Students can freely share their widgets with other users using the Play URL or Embed Code.
					</dd>
				</dl>
				<h3>Scores & Grades</h3>
				<dl>
					...
					<dd>
						...
						Additionally, student performance data can be exported at any time by clicking the Export Options button in My Widgets.
					</dd>
					<dt>My widget is embedded in the LMS but the gradebook did not update! What happened?</dt>
					<dd>This can happen for multiple reasons. First, ensure the widget is properly embedded in your LMS by reviewing <a href='https://ucfopen.github.io/Materia-Docs/create/embedding-in-canvas.html' target='_blank'>our documentation for embedding widgets in Canvas. </a>
					...
					fail or be invalidated for several reasons that are not nefarious.</dd>
				</dl>
				<h3>Widget Ownership</h3>
				<dl>
					<dt>Can I give other instructors access to a widget?</dt>
					<dd>
						Yes. Select <span className='bold'>Collaborate</span> in My Widgets to share widgets with other users. You can search for any other Materia user in the search field,
						...
						effectively makes a user a co-owner, or <span className='bold'>View Scores</span>, which allows a user to share and read score information related to a widget but they cannot edit it.
					</dd>
					<dt>Can I make students co-owners of a widget?</dt>
					<dd>
						You cannot share widgets with students unless they have been set to <span className='bold'>Guest Mode</span>, under a widget's access settings. As a general rule, Materia will not 
						...
						you co-own to Normal Access will remove the student as an owner.
					</dd>
					<dt>I see a widget embedded in my course in the LMS, but I don't own it. What do I do?</dt>
					<dd>Don't panic! Even if you don't own the widget, it will continue to function normally, and sync scores with the gradebook if configured to do so. If you're an author of the course,
